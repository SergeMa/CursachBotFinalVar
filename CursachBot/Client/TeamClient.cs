...
using CursachBot.Model;
using CursachBot.Client;
using CursachBot.Constants;

namespace CursachBot.Client
{
    public class TeamClient
    {
        ...
        {
            var responce = await _client.GetAsync($"{_address}/ActivePlayers");
            var playerList = responce.Content.ReadAsStringAsync().Result;
